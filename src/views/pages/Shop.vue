                        ...
                        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4">
                            ...
                            <div class="col">
                                    ...
                                    <div class="product-media">
                                        ...
                                        <router-link :to="{name:'product.details'}" class="product-image" ><img src="@/assets/images/product/13.png" alt="product" /></router-link>
                                    </div>
                                    <div class="product-content">
                                        <h6 class="product-name">
                            ...
                            <div class="col">
                                <div class="product-card">
                                    <div class="product-media">
                                        ...
                                        <button class="product-wish wish">
                                            <i class="fas fa-heart"></i></button><a class="product-image"
                                            href="product-video.html"><img src="@/assets/images/product/12.png" alt="product" /></a>
                                    </div>
                                    <div class="product-content">
                                        <h6 class="product-name">
                                            <a href="product-video.html">Products Name</a>

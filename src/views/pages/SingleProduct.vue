...
<template>
    <div>
        <section class="single-banner inner-section" style="
          background: url('/website/@/assets/images/single-banner.jpg') center center
            no-repeat;
        ">
            <div class="container">
                <h2>girls-cloth</h2>
                    ...
                    <div class="col-lg-6">
                        <div class="details-content">
                            ...
                            <div class="details-action-group">
                                <router-link :to="{name: 'checkout.page'}" class="details-compare"  title="Compare This Item">
                                    <i class="fas fa-random"></i>
                                    <span>Buy Now</span>
                                </router-link>
                                <a class="details-wish wish" title="Add Your Wishlist">
